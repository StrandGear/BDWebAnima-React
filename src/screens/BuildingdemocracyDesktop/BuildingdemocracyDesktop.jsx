...
 
6) Matomo
Diese Website nutzt Funktionen einer lokal installierten Webanalyse.
 
7) IP-Anonymisierung
...
export const BuildingdemocracyDesktop = () => {
 ...
 console.log("useWindowSize output:", size);

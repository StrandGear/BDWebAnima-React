...
export const BuildingdemocracyMobile = () => {
  return (
    <div className="RI">
      ...
      <img className="a" alt="A" src="../../../static/img/a-10731x2970.png" />
      <img className="pfad" alt="Pfad" src="../../../static/img/pfad-234.png" />
      <img className="img" alt="Pfad" src="../../../static/img/pfad-235.png" />
      <img className="pfad-2" alt="Pfad" src="../../../static/img/pfad-236.png" />
      <img className="pfad-3" alt="Pfad" src="../../../static/img/pfad-238.png" />
      <img className="pfad-4" alt="Pfad" src="../../../static/img/pfad-239.png" />
      <div className="buchen-als">
        Buchen als <br />
        Schulklasse
      </div>
      <div className="text-wrapper-5">Galerie</div>
      ...
      <div className="gruppe-2">
        <img className="pfad-5" alt="Pfad" src="../../../static/img/pfad-237.png" />
        <div className="text-wrapper-6">Beschreibung</div>
      </div>
      <div className="text-wrapper-7">Video</div>
      <img className="pfad-6" alt="Pfad" src="../../../static/img/pfad-243.png" />
      <p className="p">

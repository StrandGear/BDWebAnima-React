...
export const RemoteislandGallery = () => {
  return (
    <div className="remoteisland-gallery">
      ...
      <img className="pfad-11" alt="Pfad" src="/img/pfad-234-1.png" />
      <img className="pfad-12" alt="Pfad" src="/img/pfad-235-1.png" />
      <img className="pfad-13" alt="Pfad" src="/img/pfad-236-1.png" />
      <img className="pfad-14" alt="Pfad" src="/img/pfad-237-1.png" />
      <img className="pfad-15" alt="Pfad" src="/img/pfad-238-1.png" />
      <img className="pfad-16" alt="Pfad" src="/img/pfad-239-1.png" />
      <img
      ...
      <div className="gruppe-37">
        <img className="pfad-17" alt="Pfad" src="/img/pfad-242-1.png" />
      ...
      <img className="pfad-18" alt="Pfad" src="/img/pfad-243-1.png" />

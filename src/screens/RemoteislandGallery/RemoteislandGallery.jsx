...
export const RemoteislandGallery = () => {
  return (
    <div className="remoteisland-gallery">
      <div className="rechteck-23" />
      <Link className="schalter-mit-5" to="/buildingdemocracy-start">
        <div className="text-wrapper-37">BUILDING DEMOCRACY</div>
        <div className="text-wrapper-38">REMOTE ISLAND</div>
        <div className="schalter-6">
          <div className="rechteck-24" />
          <div className="uncheck-6" />
        </div>
      </Link>
      <img className="pfad-11" alt="Pfad" src="/BDWebAnima-React/img/pfad-234-1.png" />
      <img className="pfad-12" alt="Pfad" src="/BDWebAnima-React/img/pfad-235-1.png" />
      <img className="pfad-13" alt="Pfad" src="/BDWebAnima-React/img/pfad-236-1.png" />
      <img className="pfad-14" alt="Pfad" src="/BDWebAnima-React/img/pfad-237-1.png" />
      <img className="pfad-15" alt="Pfad" src="/BDWebAnima-React/img/pfad-238-1.png" />
      <img className="pfad-16" alt="Pfad" src="/BDWebAnima-React/img/pfad-239-1.png" />
      <img
        className="LOGO-op-REMOTE"
        alt="Logo REMOTE"
        src="/BDWebAnima-React/img/logo-op7-remote-island-imagotyp-2023-1.png"
      />
      <div className="gruppe-37">
        <img className="pfad-17" alt="Pfad" src="/BDWebAnima-React/img/pfad-242-1.png" />
        <p className="dauer-stunden-2">
          Dauer
          <br />3 Stunden
          <br />
          <br />
      ...
      <img className="pfad-18" alt="Pfad" src="/BDWebAnima-React/img/pfad-243-1.png" />
      ...
      <p className="nach-einer-globalen-2">
      ...
      <p className="wie-sehen-sie-ihre-2">
      ...
      <div className="text-wrapper-40">Galerie</div>
      <div className="buchen-als-gruppe-2">
        Buchen als
        <br />
        Gruppe
      </div>
      <div className="gr-e-aus-remote-2">
        Grüße aus <br />
        Remote Island
      </div>
      ...
      <img
        ...
        alt="Golden compass"
        src="/BDWebAnima-React/img/golden-compass.png"
      />
